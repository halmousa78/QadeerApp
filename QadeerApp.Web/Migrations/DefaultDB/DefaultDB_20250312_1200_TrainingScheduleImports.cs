...
[DefaultDB, MigrationKey(20250312_1200)]
public class DefaultDB_20250312_1200_TrainingScheduleImports : AutoReversingMigration
{
    public override void Up()
    {
        Create.Table("TrainingScheduleImports")
            .WithColumn("TrainingScheduleImportId").AsInt32().IdentityKey(this)
