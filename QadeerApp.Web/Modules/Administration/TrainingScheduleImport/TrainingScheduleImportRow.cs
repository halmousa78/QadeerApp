...
[ConnectionKey("Default"), Module("Administration"), TableName("TrainingScheduleImports")]
[DisplayName("Training Schedule Import"), InstanceName("Training Schedule Import")]
[ReadPermission(PermissionKeys.TrainingScheduleImport.View)]
[ModifyPermission(PermissionKeys.TrainingScheduleImport.Update)]
[InsertPermission(PermissionKeys.TrainingScheduleImport.Insert)]
[UpdatePermission(PermissionKeys.TrainingScheduleImport.Update)]
[DeletePermission(PermissionKeys.TrainingScheduleImport.Delete)]
public sealed class TrainingScheduleImportRow : Serenity.Extensions.Entities.LoggingRow<TrainingScheduleImportRow.RowFields>, IIdRow, INameRow, IIsActiveRow, IIsActiveDeletedRow, IDeleteLogRow
{
    [DisplayName("Id"), Identity, IdProperty]
    public int? TrainingScheduleImportId { get => fields.TrainingScheduleImportId[this]; set => fields.TrainingScheduleImportId[this] = value; }
    ...
    {
        public Int32Field TrainingScheduleImportId;
